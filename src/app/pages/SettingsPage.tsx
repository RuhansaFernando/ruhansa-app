...
import { Lock, Mail, Phone, MapPin, Edit, Save, X, Hash, GraduationCap, Calendar, User, BookOpen, Clock, Users2, Award, Bell, Shield, Key, CheckCircle } from 'lucide-react';
import { Avatar, AvatarFallback, AvatarImage } from '../components/ui/avatar';
import profileImage from 'figma:asset/78c46dafa44b5f9d91da87d6e0357810b5368d86.png';
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{user?.email || 'student@novara.ac.lk'}</p>
                    {studentData && (
                ...
                <div className="flex gap-2">
                  {isEditing ? (
                    <>
                      <Button variant="outline" className="border-red-600 text-red-600 hover:bg-red-50" onClick={handleCancel}>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="font-medium mt-1">{user?.email || 'student@novara.ac.lk'}</p>
                        <p className="text-xs text-muted-foreground mt-1">This is your university email and cannot be changed</p>
                      </div>
                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <Label className="text-muted-foreground text-xs">Current GPA</Label>
                              <p className="font-medium">{studentData.gpa.toFixed(2)}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <Label className="text-muted-foreground text-xs">Start Session</Label>
                          ...
                          <div className="flex items-center gap-3">
                            <Calendar className="h-4 w-4 text-muted-foreground" />
                            <div>
                              <Label className="text-muted-foreground text-xs">Expected Graduation</Label>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <Label className="text-muted-foreground text-xs">Academic Advisor</Label>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-green-900">Strong password enabled</p>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-blue-700">Your email address has been verified</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange('smsAppointments', checked)}
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange('pushAppointments', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleNotificationChange('pushAlerts', checked)}
                    />
                  </div>
                </div>
              </div>
