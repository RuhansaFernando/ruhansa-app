...
import { Search, GraduationCap, Filter, Download, AlertTriangle, Edit, UserPlus, Trash2, Mail, Users } from 'lucide-react';
...
export default function AdminStudentsPage() {
  const { students, updateStudent, users, addUser, updateUser, deleteUser } = useData();
  ...
  const [editStatus, setEditStatus] = useState<'active' | 'inactive' | 'none'>('none');
  ...
  const handleExport = () => {
    // Create CSV headers
    const headers = ['ID', 'Name', 'Email', 'Program', 'Year', 'GPA', 'Risk Level', 'Risk Score'];
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Manage all students and their user accounts</CardDescription>
          </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        setEditRiskLevel(student.riskLevel as 'low' | 'medium' | 'high' | 'critical');
                        setEditStatus(userAccount ? (userAccount.status as 'active' | 'inactive') : displayStatus as 'active' | 'inactive');
                        setIsEditDialogOpen(true);
                      }}
                    >
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={addUserFormData.status} onValueChange={(value) => setAddUserFormData({ ...addUserFormData, status: value as 'active' | 'inactive' })}>
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setAddUserFormData({ ...addUserFormData, department: value })}
              >
                <SelectTrigger className="w-full">
          ...
          <DialogFooter>
            ...
            <Button
              size="sm"
              onClick={() => {
                if (!addUserFormData.name || !addUserFormData.email || !addUserFormData.department) {
      ...
      <Dialog open={isEditUserDialogOpen} onOpenChange={setIsEditUserDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="status">Status</Label>
              <Select value={editUserFormData.status} onValueChange={(value) => setEditUserFormData({ ...editUserFormData, status: value as 'active' | 'inactive' })}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Status" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setEditUserFormData({ ...editUserFormData, department: value })}
              >
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select department" />
                </SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button
              size="sm"
              onClick={() => {
                if (!editUserFormData.name || !editUserFormData.email || !editUserFormData.department) {
                  toast.error('Please fill in all fields');
                  return;
                }
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingStudent ? "Update the student's information" : 'Add a new student to the system'}
            </DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="status">Status</Label>
              <Select value={editStatus === 'none' ? 'active' : editStatus} onValueChange={setEditStatus}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2 col-span-2">
              ...
              <Select value={editCounselor} onValueChange={setEditCounselor}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="counselor3">Dr. Maria Rodriguez</SelectItem>
          ...
          <DialogFooter className="mt-6">
            ...
            <Button
              ...
              onClick={() => {
                // Validation
                if (!editName || !editEmail || !editStudentId || !editPassword || !editDateOfBirth || 
                    !editGender || !editContactNumber || !editProgram || !editYear || !editIntake || 
                    !editEnrollmentDate || !editAdvisor) {
                ...
                if (editingStudent) {
                  ...
                  updateStudent(editingStudent.id, {
                    ...
                    gpa: editingStudent.gpa, // Keep existing GPA
                    riskLevel: editingStudent.riskLevel, // Keep existing risk level
                  });

                  const userAccount = userMap.get(editingStudent.email.toLowerCase());
                  ...
                  // Add new student (would need to be implemented in DataContext)
